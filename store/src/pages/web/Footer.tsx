...
const SITEMAP = [
    { title: "Company", links: ["About Us", "Our Team"] },
    { title: "Help Center", links: ["Facebook", "Twitter", "WhatsApp", "Instagram", "Contact Us"] },
...
export function Footer({ brand = "Your Brand" }) {
    return (
        <footer className="bg-gray-900 text-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row justify-between items-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full max-w-md">
                        <Input
                            ...
                            className="!border-gray-300 focus:!border-white"
                        />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
                {/* Brand Info */}
